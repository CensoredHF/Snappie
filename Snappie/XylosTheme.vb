...
Public Class XylosTabControl
    ...
    Protected Overrides Sub OnControlAdded(e As ControlEventArgs)
        ...
        e.Control.ForeColor = ColorFromHex("#7C858E")
        ...
        For I As Integer = 0 To TabPages.Count - 1
            ...
            If String.IsNullOrEmpty(TabPages(I).Tag) Then
                ...
                If SelectedIndex = I Then
                    ...
                    Using Background As New SolidBrush(ColorFromHex("#2B2F33")), TextColor As New SolidBrush(ColorFromHex("#BECCD9")), TextFont As New Font("Segoe UI semibold", 9)
                ...
                Else
                    ...
                    Using TextColor As New SolidBrush(ColorFromHex("#919BA6")), TextFont As New Font("Segoe UI semibold", 9)
                        G.DrawString(TabPages(I).Text, TextFont, TextColor, New Point(Rect.X + 50 + (ItemSize.Height - 180), Rect.Y + 12))
                    End Using
                ...
                If Not OverIndex = -1 And Not SelectedIndex = OverIndex Then
                    ...
                    Using Background As New SolidBrush(ColorFromHex("#2F3338")), TextColor As New SolidBrush(ColorFromHex("#919BA6")), TextFont As New Font("Segoe UI semibold", 9)
            ...
            Else
                ...
                Using TextColor As New SolidBrush(ColorFromHex("#6A7279")), TextFont As New Font("Segoe UI", 7, FontStyle.Bold), Border As New Pen(ColorFromHex("#2B2F33"))
...
Public Class XylosCheckBox
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            Using Background As New SolidBrush(ColorFromHex("#F3F4F7")), Border As New Pen(ColorFromHex("#D0D5D9")), TextColor As New SolidBrush(ColorFromHex("#7C858E")), TextFont As New Font("Segoe UI", 9)
        ...
        Else
            ...
            Using Background As New SolidBrush(ColorFromHex("#F5F5F8")), Border As New Pen(ColorFromHex("#E1E1E2")), TextColor As New SolidBrush(ColorFromHex("#D0D3D7")), TextFont As New Font("Segoe UI", 9)
                G.FillPath(Background, RoundRect(New Rectangle(0, 0, 16, 16), 3))
                G.DrawPath(Border, RoundRect(New Rectangle(0, 0, 16, 16), 3))
                G.DrawString(Text, TextFont, TextColor, New Point(25, 0))
            End Using
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            If Checked Then
                ...
                Using Background As New SolidBrush(ColorFromHex("#575C62"))
...
Public Class XylosNotice
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using Background As New SolidBrush(ColorFromHex("#FFFDE8")), MainBorder As New Pen(ColorFromHex("#F2F3F7")), TextColor As New SolidBrush(ColorFromHex("#B9B595")), TextFont As New Font("Segoe UI", 9)
            G.FillPath(Background, RoundRect(FullRectangle(Size, True), 3))
            G.DrawPath(MainBorder, RoundRect(FullRectangle(Size, True), 3))
...
Public Class XylosTextBox
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            TB.ForeColor = ColorFromHex("#7C858E")

            If State = MouseState.Down Then

                Using Border As New Pen(ColorFromHex("#78B7E6"))
...
#Region " Drawing "
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        Using Border As New Pen(ColorFromHex("#D0D5D9"))
            G.DrawPath(Border, RoundRect(FullRectangle(Size, True), 6))
        End Using

        If Not Value = 0 Then

            Using Background As New Drawing2D.HatchBrush(Drawing2D.HatchStyle.LightUpwardDiagonal, Stripes, BackgroundColor)
                G.FillPath(Background, RoundRect(New Rectangle(0, 0, Value / Maximum * Width - 1, Height - 1), 6))
            End Using
...
Public Class XylosCombobox
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Enabled Then
            ...
            Using Border As New Pen(ColorFromHex("#D0D5D9")), TriangleColor As New SolidBrush(ColorFromHex("#7C858E")), TriangleFont As New Font("Marlett", 13)
                G.DrawPath(Border, RoundRect(FullRectangle(Size, True), 6))
        ...
        Else
            ...
            Using Border As New Pen(ColorFromHex("#E1E1E2")), TriangleColor As New SolidBrush(ColorFromHex("#D0D3D7")), TriangleFont As New Font("Marlett", 13)
                G.DrawPath(Border, RoundRect(FullRectangle(Size, True), 6))
                G.DrawString("6", TriangleFont, TriangleColor, New Point(Width - 22, 3))
            End Using
        ...
        If Not IsNothing(Items) Then
            ...
            Using ItemsFont As New Font("Segoe UI", 9), ItemsColor As New SolidBrush(ColorFromHex("#7C858E"))
                ...
                Else
                    ...
                    Using DisabledItemsColor As New SolidBrush(ColorFromHex("#D0D3D7"))
    ...
    Protected Overrides Sub OnDrawItem(e As DrawItemEventArgs)
        ...
        If Enabled Then
            ...
            Try
                ...
                Using ItemsFont As New Font("Segoe UI", 9), Border As New Pen(ColorFromHex("#D0D5D9"))

                    If (e.State And DrawItemState.Selected) = DrawItemState.Selected Then

                        Using ItemsColor As New SolidBrush(Color.White), Itembackground As New SolidBrush(ColorFromHex("#78B7E6"))
                    ...
                    Else
                        Using ItemsColor As New SolidBrush(ColorFromHex("#7C858E"))
        ...
        If Enabled Then
            ...
            Select Case State
                ...
                Case MouseState.Over
                    ...
                    Using Background As New SolidBrush(ColorFromHex("#FDFDFD"))
                        G.FillPath(Background, RoundRect(FullRectangle(Size, True), 3))
                    End Using

                Case MouseState.Down

                    Using Background As New SolidBrush(ColorFromHex("#F0F0F0"))
                        G.FillPath(Background, RoundRect(FullRectangle(Size, True), 3))
                    End Using

                Case Else

                    Using Background As New SolidBrush(ColorFromHex("#F6F6F6"))
                        G.FillPath(Background, RoundRect(FullRectangle(Size, True), 3))
                    End Using
            ...
            Using ButtonFont As New Font("Segoe UI", 9), Border As New Pen(ColorFromHex("#C3C3C3"))
                G.DrawPath(Border, RoundRect(FullRectangle(Size, True), 3))
